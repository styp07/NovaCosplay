import { Heart, Calendar, MessageSquare, Users, Home } from "lucide-react";

const Footer = () => {
  return (
    <>
      {/* Footer para escritorio */}
      <footer className="hidden md:block bg-white border-t border-gray-300 py-6 mt-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-1/3 mb-6 md:mb-0">
              ...
              <p className="text-sm text-gray-600">
                ...
                miles de cosplayers, diseñadores y fans.
              </p>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-500">
              &copy; 2025 Nova Cosplay. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300 flex justify-around py-2 z-50">
        <NavButton icon={<Home size={22} />} label="Inicio" />
        <NavButton icon={<Users size={22} />} label="Cosplayers" />
        <NavButton icon={<Calendar size={22} />} label="Eventos" />
        <NavButton icon={<MessageSquare size={22} />} label="Foro" />
        <NavButton icon={<Heart size={22} />} label="Favoritos" />
      </div>
    </>
  );
};
